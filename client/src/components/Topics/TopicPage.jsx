    ...
    <div className="flex flex-col gap-2 items-center justify-center p-4">
      {
        ...
        <>
        <div key={index} className="flex w-full items-center pl-5 py-3 text-white cursor-pointer">
        ...
        <CgGhostCharacter className='m-1 size-5 hover:opacity-80' />
          t/ {t.name}
        <span className='opacity-70 text-sm pl-2 mt-0.5'>{dayjs(time[index]).fromNow()}</span>
        </Link>
        </div>
